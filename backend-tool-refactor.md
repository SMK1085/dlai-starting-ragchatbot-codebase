...
- Support for complex queries requiring multiple searches for comparisons, multi-part question, or when information from different courses/lessons is needed
...
- Terminate when: (a) 2 rounds complted, (b) Clause's response has no tool_use blocks, or (c) tool call fails
- Preserve consersation context between rounds
